...
/** ECS ticking system for {@link RotaryPivotState}. */
public class RotaryPivotSystem extends EntityTickingSystem<ChunkStore> {

    @Nonnull private final ComponentType<ChunkStore, RotaryPivotState> componentType;
    ...
    public RotaryPivotSystem(ComponentType<ChunkStore, RotaryPivotState> componentType) {
    ...
    public void tick(float dt, int index,
        ...
        RotaryPivotState state = archetypeChunk.getComponent(index, componentType);
    ...
    public static class Cleanup extends HolderSystem<ChunkStore> {
        private final ComponentType<ChunkStore, RotaryPivotState> componentType;
        public Cleanup(ComponentType<ChunkStore, RotaryPivotState> componentType) {
            this.componentType = componentType;
        }
        ...
        @Override public void onEntityRemoved(@Nonnull Holder<ChunkStore> h, @Nonnull RemoveReason r, @Nonnull Store<ChunkStore> s) {
            RotaryPivotState state = h.getComponent(componentType);
