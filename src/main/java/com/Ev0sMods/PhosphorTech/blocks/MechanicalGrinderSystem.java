...
/** ECS ticking system for {@link MechanicalGrinderState}. */
public class MechanicalGrinderSystem extends EntityTickingSystem<ChunkStore> {

    @Nonnull private final ComponentType<ChunkStore, MechanicalGrinderState> componentType;
    ...
    public MechanicalGrinderSystem(ComponentType<ChunkStore, MechanicalGrinderState> componentType) {
    ...
    public void tick(float dt, int index,
        ...
        MechanicalGrinderState state = archetypeChunk.getComponent(index, componentType);
    ...
    public static class Cleanup extends HolderSystem<ChunkStore> {
        private final ComponentType<ChunkStore, MechanicalGrinderState> componentType;
        public Cleanup(ComponentType<ChunkStore, MechanicalGrinderState> componentType) { this.componentType = componentType; }
        ...
        @Override public void onEntityRemoved(@Nonnull Holder<ChunkStore> h, @Nonnull RemoveReason r, @Nonnull Store<ChunkStore> s) {
            MechanicalGrinderState state = h.getComponent(componentType);
            if (state != null) {
                try {
