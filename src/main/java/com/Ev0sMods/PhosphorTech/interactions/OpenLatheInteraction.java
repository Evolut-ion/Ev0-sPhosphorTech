...
/**
 * "OpenLathe" interaction — no UI, pure inventory logic.
 *
 * <p>Press F: insert a valid rod-recipe input if input slot is empty,
 * or take the finished rods from the output slot.
 */
public final class OpenLatheInteraction extends CompatSimpleBlockInteraction {

    public static final BuilderCodec<OpenLatheInteraction> CODEC =
            BuilderCodec.builder(
                    OpenLatheInteraction.class,
                    OpenLatheInteraction::new,
                    SimpleBlockInteraction.CODEC)
            .documentation("Insert or take items from the Lathe block.")
            .build();
    ...
    protected void interactWithBlockCompat(
        ...
        LatheState state = LatheState.getAt(blockPos);
